...
Elm.Main.make = function (_elm) {
   ...
   var colorFormat = function (d) {
      return A2($Basics._op["++"],
      "#",
      A2($Basics._op["++"],
      A2(padWith,_U.chr("0"),$Date.hour(d)),
      A2($Basics._op["++"],A2(padWith,_U.chr("0"),$Date.minute(d)),A2(padWith,_U.chr("0"),$Date.second(d)))));
   };
   var view = function (d) {
      var c = colorFormat(d);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("background"),$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: c}]))]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("absolute-center")]),
   ...
   return _elm.Main.values = {_op: _op,dateTime: dateTime,padWith: padWith,colorFormat: colorFormat,view: view,main: main};
};
